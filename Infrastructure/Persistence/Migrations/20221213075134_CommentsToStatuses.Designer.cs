...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20221213075134_CommentsToStatuses")]
    partial class CommentsToStatuses
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Users.StatusComment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domain.Entities.Users.StatusComment", b =>
                {
                    b.HasOne("Domain.Entities.Users.Comment", "Comment")
                        .WithMany("StatusComments")
                        .HasForeignKey("CommentId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.Users.Status", "Status")
                        .WithMany("StatusComments")
