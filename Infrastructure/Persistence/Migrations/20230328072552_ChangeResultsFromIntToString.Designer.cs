...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230328072552_ChangeResultsFromIntToString")]
    partial class ChangeResultsFromIntToString
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Documents.Document", b =>
                {
                    ...
                    b.Property<string>("BackDisabilityPath")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BackInsurancePath")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Entities.Applications.Application", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Vouchers.Promocode", "Promocode")
                        .WithOne("Application")
                        .HasForeignKey("Domain.Entities.Applications.Application", "PromocodeId");
            ...
            modelBuilder.Entity("Domain.Entities.Marathons.PartnerCompany", b =>
                {
                    b.HasOne("Domain.Entities.SavedFiles.SavedFile", "Logo")
                        .WithOne("PartnerCompany")
                        .HasForeignKey("Domain.Entities.Marathons.PartnerCompany", "LogoId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Domain.Entities.Results.Result", b =>
                {
                    b.HasOne("Domain.Entities.Applications.Application", "Application")
                        .WithOne("Result")
                        .HasForeignKey("Domain.Entities.Results.Result", "ApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.Languages.Language", b =>
                {
                    ...
                    b.Navigation("PartnerTranlations");
                });
